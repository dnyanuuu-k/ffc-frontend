...
class Uploader {
    constructor(params) {
        ...
        this.headers['uploader-file-id'] = params.fileId || this._uniqid(this.file);
    ...
    _getChunk() {
        return new Promise((resolve) => {
            ...
            this._reader.onload = () => {
                this.chunk = new Blob([this._reader.result], { type: 'video/mp4' });
                resolve();
            };
    ...
    setChunkData = (currentChunk, totalChunks) => {
        this.chunkCount = currentChunk;
