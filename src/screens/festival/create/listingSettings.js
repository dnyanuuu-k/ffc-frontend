	...
	render() {
		...
		return (
			<View style={style.main}>
				...
				<Title text="Festival focus" whatIsThis={infoNote[infoType.festival_focus]} />
				<Radio
				...
				<Title text="Runtime Search" whatIsThis={infoNote[infoType.runtime_search]} />
				...
				<Title text="Listing URL" required />
				<View style={style.inputRow}>
				...
				<Title text="Tracking Sequence" whatIsThis={infoNote[infoType.sequence]} />
				<View style={style.inputRow}>
					<Input
